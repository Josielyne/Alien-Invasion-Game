...
namespace Final_Project_Final
{
    ...
    public partial class Form3 : Form
    {
        ...
        private void Form3_KeyDown(object sender, KeyEventArgs e) //Connects Shooter's movement and actions to the keyboard
        {
            ...
            if (e.KeyCode == Keys.Up) //hit up key to shoot
            {
                Bullet.Show();
        ...
        private void GameOverBox_Click(object sender, EventArgs e)//Allows player to restart the game when clicked
        {
